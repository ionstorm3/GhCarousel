export class GhCarousel {
    ...
    constructor(param) {
        ...
        this.m_containerId = "";
        this.m_interval = -1;
        this.m_cardsContainer = new Element();
        this.m_descsContainer = new Element();
        this.m_linksContainer = new Element();
    ...
    initialize() {
        ...
        if (this.m_descsContainer === null) {
            console.log("Descs container not found.");
            return;
        }
        if (this.m_linksContainer === null) {
    ...
    show(link) {
        ...
        if (idx === -1) {
            console.log("Link index not found.");
            return;
        }
        let cardsStack = [];
        let descsStack = [];
...
//# sourceMappingURL=GhCarousel.js.map